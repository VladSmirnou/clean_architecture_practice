...
# -------------------------------------------------
# How I understand the data flow of the simplest clean architecture application ->
# 1) The (Cli | Framework | GUI | ...) accepts an input from the user and 
# passes it to the Controller
# 2) The Controller packages data and passes it to the Use Cases
...
# 5) The View then just shows the result of the request to the user.
